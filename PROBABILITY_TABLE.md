...
### 特殊効果
- **コンジットパワー**: 釣り処理を2回実行（2つのアイテムを獲得可能）
...
2. **1.5秒後**: 確率情報とボーナス要因（%表示）
   - 例: `確率: 5.00% (基本: 1.00%) 宝釣り+0.80% 幸運+0.10% 雷雨+0.70% JUST+1.40% ⚡ コンジットパワー x2 ⚡`
...
- コンジットパワー時は完全に独立した2回の釣り処理が実行され、それぞれ異なるアイテムを獲得可能
